const tab = function () {
    let tabNav = document.querySelectorAll('.map__nav-item'), // Выбираем элементы навигации табов
        tabContent = document.querySelectorAll('.map__content-tab'), // Выбираем самы табы
